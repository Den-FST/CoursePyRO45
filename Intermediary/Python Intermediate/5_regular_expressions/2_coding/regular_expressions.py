...
def main():
    ...
    result = re.fullmatch(r"[A-Z]la", "ala Okla Ela")
    ...
    result = re.findall(r"kla", "Ela is fine")
    print(result)
    ...
    result = re.sub(r"[a-z]{5}", "dog", "Alice bought an elephant today")
    print(result)
    ...
    text = "Alice bought a elephaation today"
    pattern = r"[a-z]{6}"
    result = re.subn(pattern, "plant", text)
    print(result)
    ...
    text = "The price of TEST 80 ice-creams PINEAPPLE 20 MANGO 40 CHOCOLATE 30"
