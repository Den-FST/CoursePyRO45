...
def main():
    ...
    ### creating threads ###
    t4 = threading.Thread(target=iterate_odd_numbers, args=(200000000,))
    t5 = threading.Thread(target=iterate_even_numbers, args=(200000000,))
    ...
    ### creating processes ###
    p1 = multiprocessing.Process(target=iterate_odd_numbers, args=(200000000,))
    p2 = multiprocessing.Process(target=iterate_even_numbers, args=(200000000,))
